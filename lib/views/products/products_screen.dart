...
//* This function is used to display the information of the product status history
//*
//* Args:
//*   index (int): the index of the item in the list
  ...
  // void initState() {
  //   selectedPhanLoai = {
  //     'name': widget.jsonData!['content'][widget.productIndex],
  //   };
  // }
  ...
  Widget build(BuildContext context) {
    ...
    if (userInfo != null && jsonLoaiSanPham == null) {
      GetAPI('https://anphat.andin.io/index.php?r=service/get-danh-muc',
          context, 'POST', {
        'type': 'Loại sản phẩm',
        ...
        'auth': userInfo!['auth_key'],
            ...
            selectedLoaiSanPham =
                widget.jsonData!['content'][widget.productIndex]['type'],
            setState(() {}),
          }));
    }
            ...
            body: Container(
                ...
                child: ListView(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: defaultSelection(
                                'Chọn loại sản phẩm',
                                jsonLoaiSanPham == null
                                    ? []
                                    : List<
                                            DropdownMenuItem<
                                                Map<String, dynamic>>>.generate(
                                        jsonLoaiSanPham!.length,
                                        (index) => DropdownMenuItem<
                                                Map<String, dynamic>>(
                                              value: jsonLoaiSanPham![index],
                                              child: Text(
                                                  jsonLoaiSanPham![index]
                                                      ['name']),
                                            )),
                            ...
                            children: [
                              Container(
                                  ...
                                  child: textFieldWithPlaceholder(
                                      ...
                                      chieuDaiController,
                                      context, () {
                                    if (!chieuDaiController.text.isEmpty &&
                                        !chieuRongController.text.isEmpty) {
                                      dienTichController.text =
                                          (int.parse(chieuDaiController.text) *
                                                  int.parse(
                      ...
                      children: [
                        Container(
                            ...
                            child: textFieldWithPlaceholder(
                                'Độ rộng đường (m)',
                                'number',
                                doRongDuongController,
                                context,
                                () {})),
                        Container(
                            width: MediaQuery.of(context).size.width / 2 - 15,
                            child: textFieldWithPlaceholder('Diện tích (m2)',
                                'number', dienTichController, context, () {})),
                      ],
                    ),
                    contentHeaderWithoutAdd('Giá cả'),
                    textFieldWithPlaceholder(
                        'Giá bán', 'number', giaTienController, context, () {}),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Container(
                            ...
                            child: defaultSelection(
                                'Chọn loại hoa hồng',
                                jsonLoaiHoaHong == null
                                    ? []
                                    : List<
                                            DropdownMenuItem<
                                                Map<String, dynamic>>>.generate(
                                        jsonLoaiHoaHong!.length,
                                        (index) => DropdownMenuItem<
                                                Map<String, dynamic>>(
                                              value: jsonLoaiHoaHong![index],
                                              child: Text(
                                                  jsonLoaiHoaHong![index]
                                                      ['name']),
                                            )),
                        ...
                        Container(
                            width: MediaQuery.of(context).size.width / 2 - 15,
                            child: textFieldWithPlaceholder('Hoa hồng',
                                'number', hoaHongController, context, () {})),
                      ],
                    ),
                    ...
                    textFieldWithPlaceholder(
                        'Địa chỉ', 'text', diaChiController, context, () {}),
                    contentHeaderWithoutAdd('Thông tin thêm'),
                    textFieldWithPlaceholder('Họ tên chủ sở hữu', 'text',
                        hoTenChuHoController, context, () {}),
                    textFieldWithPlaceholder('Số điện thoại', 'text',
                        soDienThoaiController, context, () {}),
                    ...
                    textFieldWithPlaceholder('Ghi chú', 'multiline',
                        ghiChuController, context, () {}),
                    primarySizedButton('Tạo mới', context, () async {
                      var prefs = await SharedPreferences.getInstance();
                      String? coords = await prefs.getString('selectedCoord');
                      GetAPI(
                          'https://anphat.andin.io/index.php?r=service/save-san-pham',
                          context,
                          'POST', {
                        'id': '',
                        'toa_do_vi_tri': coords != null ? coords : '',
                        'phan_loai': selectedPhanLoai != null
                            ? selectedPhanLoai!['id'].toString()
                            : '',
                        'type': selectedLoaiSanPham != null
                            ? selectedLoaiSanPham!['id'].toString()
                            : '',
                        'xa_phuong_id': selectedXaPhuong != null
                            ? selectedXaPhuong!['id'].toString()
                            : '',
                        'duong_pho_id': selectedDuongPho != null
                            ? selectedDuongPho!['id'].toString()
                            : '',
                        'thon_xom_id': selectedThonXom != null
                            ? selectedThonXom!['id'].toString()
                            : '',
                        'gia_tu': giaTienController.text,
                        'dia_chi': diaChiController.text,
                        'huong':
                            selectedHuong != null ? selectedHuong!['name'] : '',
                        ...
                        'loai_hoa_hong': selectedLoaiHoaHong != null
                            ? selectedLoaiHoaHong!['id'].toString()
                            : '',
                        'hoa_hong': hoaHongController.text,
                        'phap_ly': selectedPhapLy != null
                            ? selectedPhapLy!['id'].toString()
                            : '',
